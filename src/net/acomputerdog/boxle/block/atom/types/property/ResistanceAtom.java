...
public class ResistanceAtom extends Atom {
    public ResistanceAtom(String name) {
        super(null, "PROPERTY.RESISTANCE", name);
    }
    ...
    public void execute(Sim sim, Stack stack, Block block) throws SimException {
        ...
        block.setResistance((Float) stack.pop().getObj());
    }
}
